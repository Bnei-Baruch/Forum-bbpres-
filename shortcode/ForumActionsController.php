...
class ForumActionsController {
	...
	/**
	 * 
	 * @param int $topicId: parent topic id (-1 = all)
	...
	/***
	 * Heppend on Error. Stop run any php and return to brouser JSON
	...
	/** 
	 * @param string $forObject: bool, false if was called from AJAX 
